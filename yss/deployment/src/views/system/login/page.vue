...
<!--                  </el-input>-->
<!--                </el-form-item>-->
                <p class="page-login--options" flex="main:justify cross:center" v-show="false">
                  <span><d2-icon name="question-circle"/> {{ $t('login.forgetPassword') }}</span>
                  <span>{{ $t('login.registeredUser') }}</span>
                </p>
        ...
        <div class="page-login--content-footer">
          ...
          <p class="page-login--content-footer-copyright">
            ...
            2019 QuarkUI 赢时胜出品
            <a href="http://www.ysstech.com" target="_blank">
              @YSSTECH
            </a>
          </p>
...
import localeMixin from '@/lang/mixin.js';
...
export default {
  ...
  mounted() {
    ...
    if (window.opener) {
      console.log('存在window.pener, xxxxx');
  ...
  methods: {
    ...
    receiveMessage(event) {
      ...
      if (event.origin && event.data.token) {
