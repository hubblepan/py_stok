<template>
  <!-- 新增节点 -->
  <el-dialog title="添加升级包" :visible.sync="showDialog" width="680px"  :close-on-click-modal="false" :close-on-press-escape="false" append-to-body>
...
export default {
  name: 'NodeUpgradeUploadAdd',
  components: { NodeUpgradeUpload, NodeUpgradeLoading },
  props: ['onAdded'],
  data() {
    return {
      showDialog: false,
  ...
  methods: {
    ...
    execAdd() {
      ...
      this.onAdded(api.uploadZipForNode(fileData), this.index);
    },
  },
};
</script>
