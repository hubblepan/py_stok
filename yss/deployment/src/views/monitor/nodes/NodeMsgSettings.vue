  ...
  <div v-loading="configInfoLoading">
    <el-form :model="formData" :rules="rules" id="configForm" label-width="180px" ref="configForm" label-position="left">
      <el-row :gutter="10">
        ...
        <el-col :span="20" v-if="formData.isAdvance">
          <el-form-item label="消息总线地址" prop="mqAddress">
            <el-input placeholder="集群配置地址" v-model="formData.mqAddress" :title="formData.mqAddress"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="4">
          <el-checkbox v-show="false" :checked="formData.isAdvance" v-model="formData.isAdvance" @change="onAdvanceChanged" style="padding-top:10px">集群配置</el-checkbox>
        </el-col>
      </el-row>
