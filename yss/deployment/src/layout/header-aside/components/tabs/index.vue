<template>
  <div class="d2-multiple-page-control-group" flex>
    ...
    <div class="d2-multiple-page-control-btn" flex-box="0" style="visibility: hidden">
      <el-dropdown split-button @click="closeAll" @command="command => handleControlItemClick(command)">
...
export default {
  ...
  created () {
    console.log(this.$store.state.d2admin.menu);
  },
  computed: {
