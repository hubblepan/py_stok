    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div
        ...
        <div class="logo-group" :style="{width: asideCollapse ? asideWidthCollapse : asideWidth}" flex-box="0">
          ...
          <img :src="`${$baseUrl}image/theme/${themeActiveSetting.name}/logo/icon-only.png`" style="height:26px">
          <span v-if="!asideCollapse">部署监控中心</span>
        </div>
...
import asModal from '@/views/system/password/index.vue';
