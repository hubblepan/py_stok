...
const IndexPage = () => {
  ...
  // const { detailVisible, modalOperate, detailData, changeVisible, permission, permitVisible, testVisible, deployVisible, currentDetail, masterSelectedRows, primaryKey, subColumns,} = userRightManageSub;
  // 子表属性
  ...
  // handles
  const rightManageSubHandle = new RightManageSubHandle({ ...userRightManageSub, masterSelectedRows: userRightManageSub.selectedRows});
  /** ************************** 用户权限分配子表属性结束 *************************** */
