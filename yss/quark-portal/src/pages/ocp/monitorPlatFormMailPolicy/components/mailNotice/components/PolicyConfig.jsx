...
const PolicyConfig = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) =>
        record.indexState.map((item, index) => {
          return <Checkbox key={index}>{item.text}</Checkbox>;
        }),
    },
  ];
  ...
  return (
    <>
      <div className={styles.panel}>
        ...
        {mode === '1' ? (
          <QuarkTable rowKey="id" columns={columns} dataSource={tableData} rowSelection={false} />
        ) : null}
        {mode === '2' ? (
          <QuarkTable
            rowKey="id"
          ...
          <Row>
            <Col span={24}>
              <Form.Item
                ...
                rules={[{ required: true, message: '请输入内容!' }]}
              >
                <Checkbox onChange={onChange}>指标明细列表</Checkbox>
                <Checkbox onChange={onChange}>监控日志总览列表</Checkbox>
              </Form.Item>
            </Col>
          </Row>
          <Row>
              ...
              >
                ...
                {value === 'yes'
                  ? [
                      ...
                      >
                        <Form.Item label="压缩分卷">
                          <Input />
                        </Form.Item>

                        <Form.Item label="压缩前缀">
                          <Input />
                        </Form.Item>
                      </Form>,
                    ]
